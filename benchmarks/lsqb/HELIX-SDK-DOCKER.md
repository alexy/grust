...
The Helix SDK3 server candidate is still being built/qualified. No live SDK3
pass, performance measurement or publication admission is claimed by this
guide. The measured plan remains backend materialization plus Rust reference
