...
#[cfg(feature = "sail")]
pub use grust_sail::{
    CypherMutationReport, SailConfig, SailDegreePairRow, SailDegreeRow, SailGraphPatternDirection,
    SailGraphStore, SailGraphTypedTable, SailGraphTypedTableKind, SailTripletRow,
    sail_cypher_mutation_plan, sail_degree_pairs_sql, sail_degrees_sql,
...
pub mod prelude {
    ...
    #[cfg(feature = "sail")]
    pub use grust_sail::{
        CypherMutationReport, SailConfig, SailDegreePairRow, SailDegreeRow,
