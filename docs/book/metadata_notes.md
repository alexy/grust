...
```xml
<dc:title id="epub-title-1">grust (0.6.4)</dc:title>
<meta refines="#epub-title-1" property="file-as">grust (0.6.4)</meta>
```
...
- the versioned Send to Kindle path, such as `grust (0.6.4).epub`, is missing
...
readlink "build/dist/grust (0.6.4).epub"
