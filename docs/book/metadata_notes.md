...
```xml
<dc:title id="epub-title-1">grust (0.6.8)</dc:title>
<meta refines="#epub-title-1" property="file-as">grust (0.6.8)</meta>
```
...
- the versioned Send to Kindle path, such as `grust (0.6.8).epub`, is missing
...
readlink "build/dist/grust (0.6.8).epub"
