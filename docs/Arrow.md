...
```toml
[dependencies]
grust = { package = "grust-graph", version = "0.7.1", features = ["ladybug-arrow"] }
```
...
```toml
[dependencies]
grust-ladybug = { version = "0.7.1", features = ["arrow"] }
```
...
```toml
[dependencies]
grust = { package = "grust-graph", version = "0.7.1", features = ["sail"] }
```
